...
public class PostsApiControllerTest {
    ...
    public void savePosts() throws Exception {
        ...
        Posts postObj = all.get(0);
        assertThat(postObj.getTitle()).isEqualTo(title);
        assertThat(postObj.getContent()).isEqualTo(content);
    }
    ...
    public void updatePosts() throws Exception {
        ...
        List<Posts> all = postsRepository.findAll();
        Posts postObj = all.get(0);
        assertThat(postObj.getTitle()).isEqualTo(expectedTitle);
        assertThat(postObj.getContent()).isEqualTo(expectedContent);
    }
}
